...
var _default = async bp => {
   ...
   */
  const router = bp.http.createRouterForBot('complete-module'); // Link to access this route: http://localhost:3000/api/v1/bots/BOT_NAME/mod/complete-module/my-first-route
